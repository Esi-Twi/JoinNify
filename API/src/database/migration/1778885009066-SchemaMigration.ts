...
export class SchemaMigration1778885009066 implements MigrationInterface {
    name = 'SchemaMigration1778885009066'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "events" ADD "desc" character varying NOT NULL`);
